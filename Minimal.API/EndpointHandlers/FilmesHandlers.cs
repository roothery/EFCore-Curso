...
public static class FilmesHandlers
{
    ...
    public static async Task<IEnumerable<Filme>> GetFilmeEFFUnctionsByTituloAsync(string titulo, Context context)
    {
        return await context.Filmes
                .Include(filme => filme.Diretores)
                .Where(filme =>
    ...
    public static async Task<IEnumerable<Filme>> GetFilmesContainsbyTituloAsync(string titulo, Context context)
    {
        return await context.Filmes
                .Include(filme => filme.Diretores)
