...
public class Context(DbContextOptions<Context> options) : DbContext(options)
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
          ...
          f =>
            {
                ...
                f.Property(filme => filme.Orcamento)
          ...
          d =>
            {
              d.HasMany(d => d.Filmes)
                ...
                d.Property(diretor => diretor.Id).HasColumnName("Diretor_Id");
        ...
        modelBuilder.Entity<DiretorDetalhe>(
          dd =>
            {
                //Comando para o SQL Server
                //dd.Property(dd => dd.DataCriacao).HasDefaultValueSql("GETDATE()");

                //Comando para o SQLite
                //dd.Property(dd => dd.DataCriacao).HasDefaultValueSql("CURRENT_TIMESTAMP");
